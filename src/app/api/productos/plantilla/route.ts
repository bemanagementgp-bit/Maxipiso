...
async function hojaDeInstrucciones(): Promise<string[][]> {
  ...
  return [
    ...
    ["VARIANTES"],
    [],
    ["", "Sirven para que un producto que viene en varios colores o medidas sea una"],
    ["", "sola página con botones para elegir, en vez de ocho productos repetidos."],
    [],
    ["Variante de", "SKU del producto principal. Dejalo vacío en el principal."],
    ["Opciones variante", "En qué se diferencia, con el formato Tipo: valor."],
    [],
    ["", "Varias opciones van separadas por punto y coma. Ej: Color: Roble ; Medidas: 120x20"],
    ["", "Los tipos habituales son Color y Medidas, pero podés escribir el que quieras"],
    ["", "(Acabado, Espesor, Terminación…). El mismo tipo en todas las filas del grupo."],
    ["", "Cada variante lleva sus propios precio, imagen, stock y medidas."],
    ["", "Las variantes no aparecen sueltas en el catálogo: se ven dentro del principal."],
    [],
