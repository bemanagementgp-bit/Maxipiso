...
export const CATEGORY_CONFIGS: CategoryConfig[] = [
  {
    ...
    fields: [
      ...
      { key: "varianteEtiqueta",   label: "Etiqueta variante", type: "text" },
      ...GARANTIA_FIELD,
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "subtipo",      label: "Subtipo",      type: "text",   gridVisible: true },
      { key: "compatibleCon",      label: "Compatible con",   type: "text" },
      { key: "composicion",        label: "Composición",      type: "text" },
      { key: "espesor",      label: "Espesor",      type: "text",   gridVisible: true },
